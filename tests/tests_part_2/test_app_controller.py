...
class TestAppController:
    ...
    def controller(self, mock_window, mock_data_manager):
        ...
        with patch("MVP.presenters.app_controller.PlanixModel") as mock_model_cls, \
             patch("MVP.presenters.app_controller.ScheduleCollectionManager") as mock_manager_cls, \
             patch("MVP.presenters.app_controller.InputPresenter") as mock_input_pres_cls, \
             patch("MVP.presenters.app_controller.CalendarPresenter") as mock_cal_pres_cls:
    ...
    def test_controller_maintains_single_persistent_state_context(self, mock_window, mock_data_manager):
        ...
        with patch("MVP.presenters.app_controller.PlanixModel") as mock_model_cls, \
             patch("MVP.presenters.app_controller.ScheduleCollectionManager"), \
             patch("MVP.presenters.app_controller.InputPresenter") as mock_input_pres_cls, \
             patch("MVP.presenters.app_controller.CalendarPresenter") as mock_cal_pres_cls:
